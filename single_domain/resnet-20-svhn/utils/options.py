...
parser.add_argument('--job_dir', type = str, default = f'experiment/resnet/{METHOD}/t_{INDEX}/', help = 'The directory where the summaries will be stored.') # 'experiments/'
...
parser.add_argument('--source_file', type = str, default = 'res20_32bit/model_best.pt', help = 'The file the teacher model weights saved as.')
