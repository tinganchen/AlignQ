...
parser.add_argument('--job_dir', type = str, default = f'experiment/{METHOD}/dense/t_{INDEX}/', help = 'The directory where the summaries will be stored.') # 'experiments/'
...
parser.add_argument('--source_file', type = str, default = 'dense_32bit/densenet_40.pt.tar', help = 'The file the teacher model weights saved as.')
...
parser.add_argument('--target_model', type = str, default = 'densenet_40_quant', help = 'The target model.')

parser.add_argument('--source_model', type = str, default = 'densenet_40', help = 'The baseline model.') 
...
parser.add_argument('--lr_decay_steps', type = list, default = [80, 120])
# 1. train: default = 30
